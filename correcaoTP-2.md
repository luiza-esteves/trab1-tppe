...
- Refatoração 3:   
  - Critério 1:  Ok 
  - Critério 2:  NOk - Não há referência para a classe de origem do
    método-objeto, o método CalculadoraImpostos::calcular continua tendo
    variáveis temporárias em sua implementação. -60 pontos.
  - Critério 3:  Ok 
